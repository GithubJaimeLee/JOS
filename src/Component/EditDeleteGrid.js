...
const getListStyle = (isDraggingOver) => ({
  ...
  gridTemplateColumns: "78px 78px 78px 78px",
  position: "relative",
  gridAutoRows: 78,
  paddingTop: 100,
});

function EditDeleteGrid() {
  ...
  return (
    <div>
      <div style={{ display: "grid", position: "absolute" }}>
        <DragDropContext className="here" onDragEnd={onDragEnd}>
          {state.map((el, ind) => (
